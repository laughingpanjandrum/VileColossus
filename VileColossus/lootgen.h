...
namespace lootgen
{
	...
	const vector<ItemEnchantment> LEGENDARY_ENCHANTS = { 
		ENCH_AFFINITY, ENCH_ARCANE_SHIELD, ENCH_BLACKBLOOD, ENCH_CONDUCTING, ENCH_CUNNING, ENCH_DARK_ARCANA, ENCH_DIVINE, ENCH_FIREBURST, ENCH_FLAMESPIKE, ENCH_KINSLAYER,
