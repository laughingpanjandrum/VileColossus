...
namespace lootgen
{
	...
	const vector<ItemEnchantment> LEGENDARY_ENCHANTS = { 
		ENCH_AFFINITY, ENCH_ARCANE_SHIELD, ENCH_AVARICE, ENCH_BLACKBLOOD, ENCH_CONDUCTING, ENCH_CUNNING, ENCH_DARK_ARCANA, ENCH_DIVINE, ENCH_FIREBURST, ENCH_FLAMESPIKE, ENCH_KINSLAYER, ENCH_PETRIFYING,
		ENCH_SHADOWSTRIKE, ENCH_SPELLBURN, ENCH_STORMBURST, ENCH_THUNDERSPIKE, ENCH_VENOMBURST, ENCH_VENOMSPIKE, ENCH_WEIGHT, 
	};
