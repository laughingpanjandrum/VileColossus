...
namespace lootgen
{
	...
	const vector<ItemEnchantment> LEGENDARY_ENCHANTS = { 
		ENCH_AFFINITY, ENCH_ARCANE_SHIELD, ENCH_AVARICE, ENCH_BLACKBLOOD, ENCH_CONDUCTING, ENCH_CUNNING, ENCH_DARK_ARCANA, ENCH_DIVINE, ENCH_FIREBURST, ENCH_FLAMESPIKE, ENCH_KINSLAYER, ENCH_MAGEBLOOD, ENCH_PETRIFYING,
	...
	const vector<Spell> SPELLS_TIER_3 = { Spell::CRYSTAL_SPEAR, Spell::FIRESTORM, Spell::STATIC_FIELD, };
