...
namespace lootgen
{
	...
	enum class BaseWeaponType { 
		...
		BATTLE_AXE, WAR_AXE, BROAD_AXE, GREAT_AXE, DOUBLE_AXE, TITAN_AXE, 
		CLUB, MACE, WARHAMMER, GREATCLUB, GREATHAMMER, GREATMAUL,
		CROSSBOW, HEAVY_CROSSBOW, DOUBLE_CROSSBOW,
		DAGGER, STILETTO, LONG_KNIFE,
		LONGSPEAR, HALBERD, DEMONGLAIVE,
		SHORTBOW, LONGBOW, GREATBOW,
		SHORTSWORD, LONGSWORD, DEMON_BLADE, BASTARD_SWORD, GREATSWORD, DEMON_GREATBLADE,
		SPEAR, WARPIKE, DEMON_PIKE,
	...
	const vector<ItemEnchantment> LEGENDARY_ENCHANTS = { 
		ENCH_AFFINITY, ENCH_ARCANE_SHIELD, ENCH_AVARICE, ENCH_BERSERKER, ENCH_BLACKBLOOD, ENCH_CONDUCTING, ENCH_CRUCIBLE, ENCH_CUNNING, ENCH_DANCER,
		...
		ENCH_SADIST, ENCH_SHADOWSTRIKE, ENCH_SKYSPLITTER, ENCH_SPELLBURN, ENCH_STORMBURST, ENCH_THUNDERSPIKE, ENCH_VENOMBURST, ENCH_VENOMSPIKE, ENCH_WEIGHT, 
	};
