...
namespace lootgen
{
	...
	const vector<ItemEnchantment> LEGENDARY_ENCHANTS = { 
		ENCH_AFFINITY, ENCH_ARCANE_SHIELD, ENCH_BLACKBLOOD, ENCH_CONDUCTING, ENCH_CUNNING, ENCH_DIVINE, ENCH_FIREBURST, ENCH_SHADOWSTRIKE, ENCH_SPELLBURN, ENCH_STORMBURST, ENCH_VENOMBURST, ENCH_WEIGHT, 
	};
