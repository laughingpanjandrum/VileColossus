...
enum StatusEffect { STATUS_AGONY, STATUS_BURN, STATUS_POISON, STATUS_SHOCK, STATUS_SLUDGED, STATUS_STAGGER, STATUS__MAX, };

const vector<StatusEffect> ALL_STATUS_EFFECTS = { STATUS_AGONY, STATUS_BURN, STATUS_POISON, STATUS_SHOCK, STATUS_SLUDGED, STATUS_STAGGER };
...
enum BuffType { BUFF_ARCANE_PULSE, BUFF_EMPOWERED, BUFF_HASTE, BUFF_SMITE_EVIL, BUFF_STONESKIN, BUFF_TOXIC_RADIANCE, BUFF_VENOMFANG, BUFF_WRATH, BUFF__MAX, };
