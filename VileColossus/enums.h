...
enum BuffType { BUFF_ARCANE_PULSE, BUFF_CONDUCTION, BUFF_EMPOWERED, BUFF_HASTE, BUFF_SMITE_EVIL, BUFF_STONESKIN, BUFF_TOXIC_RADIANCE, BUFF_VENOMFANG, BUFF_WRATH, BUFF__MAX, };
