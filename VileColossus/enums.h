...
enum ItemEnchantment
{
	...
	ENCH_DARK_ARCANA, ENCH_DERVISH, ENCH_DIVINE,
...
enum BuffType { 
	BUFF_ARCANE_PULSE, BUFF_CONDUCTION, BUFF_CRIT_BONUS, BUFF_EMPOWERED, BUFF_HASTE, BUFF_REGENERATION, BUFF_SMITE_EVIL, BUFF_STATIC_FIELD, BUFF_STONESKIN, BUFF_TOXIC_RADIANCE, BUFF_VENOMFANG, BUFF_WRATH, 
	BUFF__MAX, };
