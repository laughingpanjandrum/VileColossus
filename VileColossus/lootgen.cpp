...
const vector<ItemEnchantment> lootgen::getEnchantmentsForItemCategory(const ItemCategory cat)
{
	...
	case(ITEM_RING):
		return { ENCH_ACCURACY, ENCH_AFF_ARCANE, ENCH_AFF_ELECTRIC, ENCH_AFF_FIRE, ENCH_AFF_POISON,
			ENCH_ARMOURING, ENCH_DEFENCE, ENCH_FLAMEWARD, ENCH_LEECHING, ENCH_LIFE, ENCH_LIGHT, ENCH_MAGIC, ENCH_MANALEECH, ENCH_POISON_WARD, ENCH_RAGE,
	...
	case(ITEM_HELMET):
	case(ITEM_SHOULDERS):
		return { ENCH_ACCURACY, ENCH_AFF_ARCANE, ENCH_AFF_ELECTRIC, ENCH_AFF_FIRE, ENCH_AFF_POISON, ENCH_FLAMEWARD, ENCH_LIFE, ENCH_LIGHT, ENCH_MAGIC, ENCH_POISON_WARD, ENCH_RAGE, ENCH_SLAYING,
			ENCH_SPELLPOWER, ENCH_SPELLWARD, ENCH_STORMWARD, ENCH_THORNS, ENCH_WOUNDING, };

	case(ITEM_SHIELD):
		return { ENCH_AFF_ARCANE, ENCH_AFF_ELECTRIC, ENCH_AFF_FIRE, ENCH_AFF_POISON,
			ENCH_FLAMEWARD, ENCH_LIFE, ENCH_LIGHT, ENCH_MAGIC, ENCH_POISON_WARD, ENCH_SHARPNESS, ENCH_SPELLPOWER, ENCH_SPELLWARD, ENCH_STORMWARD, ENCH_THORNS, ENCH_WOUNDING, };

	case(ITEM_WEAPON):
		return { ENCH_ACCURACY, ENCH_AFF_ARCANE, ENCH_AFF_ELECTRIC, ENCH_AFF_FIRE, ENCH_AFF_POISON, ENCH_ARCANE, ENCH_BURNING, ENCH_DEFENCE, ENCH_LEECHING, ENCH_LIGHTNING, ENCH_MANALEECH,
...
int lootgen::rollEnchantmentBonus(const ItemEnchantment en)
{
	...
	case(ENCH_AFF_FIRE):
	case(ENCH_AFF_POISON):		return randint(2, 10) * 5;
