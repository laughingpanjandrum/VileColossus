...
enum Maptile
{
	MT_ALCHEMY, MT_ANVIL, MT_FORGE, MT_GEMSTONE_PRESS,
	MT_BARREL,
	MT_BUSH,
	MT_CHEST_SMALL, MT_CHEST_GLOWING, MT_CHEST_RADIANT,
	MT_DOOR_STONE, MT_DOOR_WOODEN,
	MT_FLOOR_CARPET, MT_FLOOR_HOT, MT_FLOOR_STONE, MT_FLOOR_STONE2,
	MT_GRASS,
	MT_HEALING_FOUNTAIN,
	MT_LAVA,
	...
	MT_THORNS,
	MT_TREE_DEAD,
	MT_WALL_BLOODY, MT_WALL_SANDSTONE, MT_WALL_STONE, MT_WALL_SUPER,
	MT_WATER,
...
enum class Surface { BONES, CORPSE, POISON_OOZE, SLUDGE, __NONE, };
